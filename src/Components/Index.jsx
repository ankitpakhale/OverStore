          ...
          <div className="row">
              ...
              <Link to="/product" className="portfolio-card">
                ...
                <span className="portfolio-card-overlay">
                  <span className="portfolio-card-caption">
                    <h4>Ice Cream Delivery</h4>
                    <p className="font-weight-normal">Category: Food</p>
                  </span>
                </span>
              </Link>
            </div>
            <div className="col-md-4">
              <Link to="/product" className="portfolio-card">
                <img
                  ...
                  src={require("../assets/imgs/folio-2.gif")}
                  alt="Product"
                />
                <span className="portfolio-card-overlay">
                  <span className="portfolio-card-caption">
                    <h4>Watch Delivery</h4>
                    <p className="font-weight-normal">Category: watch</p>
                  </span>
                </span>
              </Link>
            </div>
            <div className="col-md-4">
              <Link to="/product" className="portfolio-card">
                ...
                <span className="portfolio-card-overlay">
                  <span className="portfolio-card-caption">
                    <h4>Daily Use Product Delivery</h4>
                    <p className="font-weight-normal">
                      Category: Daily Use Product
                    </p>
                  </span>
                </span>
              </Link>
